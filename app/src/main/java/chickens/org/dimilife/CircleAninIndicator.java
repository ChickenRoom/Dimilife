...
public class CircleAninIndicator extends LinearLayout {
    ...
    public CircleAninIndicator(Context context) {
        super(context);
        this.context = context;
    }


    public CircleAninIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    }

    public CircleAninIndicator(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.context = context;
    }

    public CircleAninIndicator(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
